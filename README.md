...
**Lớp:** 3A · **Phòng:** E403 · **Cụm:** C3 · **Track:** B — Trợ lý Discord

| Họ và Tên | Mã Học Viên | Vai trò chính | Phần việc đảm nhiệm trong dự án |
|---|---|---|---|
| Nguyễn Đức Danh | 2A202602722 | Đội trưởng · Product/Spec | `spec.md`; khảo sát và mining trong `research/`; `eval/quality_bar.py`, golden lượt 4, bộ held-out 22 case và phân tích, phiếu chấm độc lập; `codebase/README.md`, `ARCHITECTURE.md`, CI, ruff; nộp form CP1–CP5; slide |
| Bùi Gia Chính | 2A202602693 | AI Engineer | `codebase/dcc/`: quyết định trung tâm `decide.py` (prompt + guard), nạp nguồn `ingest.py`, `llm.py` (rate limit, retry), sổ nguồn `registry.py` và `data/registry.json`, `prompts/` |
| Lê Phan Việt Cường | 2A202602641 | Frontend/UX | Bot Discord `codebase/bot/` (lệnh, embed, nút, modal, `#ta-queue`, `#announcements`, nhắc hạn), web dự phòng `codebase/web/`, mock CP2; bảng nguyên tắc HAX/PAIR; video CP3 và video dự phòng |
| Nguyễn Quang Duy | 2A202602426 | Research & Eval | Golden set 27 case, bộ nạp nguồn 10 thông báo, `run_eval.py`, `run_ingest_eval.py`, baseline Kute, 3 lượt golden đầu; `codebase/tests/`; spec §5; `validation/` |
